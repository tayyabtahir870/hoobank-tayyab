      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6 mt-5">
            <label className="labeltext" htmlFor=""><img src="Assests/Discount.svg" alt="" />20% <span className="discount">DISCOUNT FOR</span> 1 MONTH <span className="discount">ACCOUNT</span></label>
